        ...
        <Box {...wrapper}>
            <Grid {...portfolioGridInfoStyles}>
                <Box {...portfolioInfoWrapper}>
                    ...
                    <Text {...portfolioDescription}>
                        Within our vibrant ecosystem, we&apos;ve cultivated a
                        dynamic founder community consisting of over 2000
                        passionate visionaries, united by their drive to
                        innovate and reshape industries.
                    </Text>
                </Box>
            ...
            <Grid {...portfolioGridInfoStyles}>
                <Box {...portfolioInfoWrapper}>
                    ...
                    <Text {...portfolioDescription}>
                        Our dedicated team of 50+ mentors brings a wealth of
                        knowledge and expertise across various fields, ensuring
                        you have access to a wide range of valuable guidance and
                        support.
                    </Text>
                </Box>
                <Box {...portfolioContent}>
            ...
            <Grid {...portfolioGridInfoStyles}>
                <Box {...portfolioInfoWrapper}>
                    ...
                    <Text {...portfolioDescription}>
                        We&apos;ve turbocharged over 80 startups on their
                        journey to success, propelling them forward with our
            ...
            <Grid {...portfolioGridInfoStyles}>
                <Box {...portfolioInfoWrapper}>
                    ...
                    <Text {...portfolioDescription}>
                        We&apos;ve successfully secured over a dozen funding
                        rounds to fuel the growth of our high-velocity startups.
                    </Text>
                </Box>
                <Box {...portfolioContent}>
